...
class App extends Component {
  ...
  <div id="home" className="intro route bg-image" style="background-image: url(img/intro-bg.jpg)">
  ...
  <div className="section-counter paralax-mf bg-image" style="background-image: url(img/counters-bg.jpg)">
  ...
  <section className="paralax-mf footer-paralax bg-image sect-mt4 route" style="background-image: url(img/overlay-bg.jpg)">
    <div className="overlay-mf"></div>
    <div className="container">
      <div className="row">
        <div className="col-sm-12">
